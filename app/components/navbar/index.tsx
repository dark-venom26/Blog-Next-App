    ...
    <div className="bg-gray-100 shadow-md py-3 px-6 w-full flex items-center justify-between">
        <div className="flex justify-between gap-7">
            <div className="flex gap-x-4">
                ...
                {loggedIn && <Link className="font-medium px-3 py-2 hover:text-orange-300" prefetch href="/blog">Create Blog</Link>}
            </div>
        ...
        <div className="flex gap-5">
            ...
            <div className="flex gap-4">
                {
                    loggedIn ? <button className="hover:bg-green-300 hover:text-green-950 p-4 h-6 rounded-md outline-none cursor-pointer flex items-center justify-center text-white bg-green-950 transition-all duration-100 font-semibold">Sign Out</button> : 
                    <>
